...
public final class LoginPageBinding implements ViewBinding {
  ...
  private LoginPageBinding(@NonNull ConstraintLayout rootView, @NonNull Button signInButton) {
  ...
  public static LoginPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LoginPageBinding((ConstraintLayout) rootView, signInButton);
    }
